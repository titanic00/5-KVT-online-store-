(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-block__swiper")) new core(".main-block__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".slider-products_top")) new core(".slider-products_top", {
            ...
            if (document.querySelector(".slider-products_new")) new core(".slider-products_new", {
                modules: [ Navigation, Grid ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".slider-products_card")) new core(".slider-products_card", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".advantages-page__slider")) new core(".advantages-page__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".comments-feedback__slider")) new core(".comments-feedback__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".addresses-contacts__slider")) new core(".addresses-contacts__slider", {
            ...
            if (document.querySelector(".delivery-main__slider")) new core(".delivery-main__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        catalogButton.addEventListener("click", (() => {
            if (catalogNavigation.classList.contains("menu-bottom-header_submenu-open")) catalogNavigation.classList.remove("menu-bottom-header_submenu-open");
        ...
        catalogMenu.forEach((el => el.addEventListener("click", (event => {
            ...
            if (catalogSubmenu[submenuNumber]) {
                for (let i = 0; i < catalogSubmenu.length; i++) catalogSubmenu[i].classList.remove("submenu-menu-bottom__item_active");
        ...
        if (window.innerWidth < 575.98) advantagesList.forEach((el => el.classList.toggle("swiper-slide")));
        const openFilterBtn = document.querySelector(".view-page__filter-button");
        const script_filter = document.querySelector(".products-catalog__filter");
        if (openFilterBtn) openFilterBtn.addEventListener("click", (() => {
            script_filter.classList.toggle("products-catalog__filter_open");
        }));
        ymaps.ready(init);
        function init() {
        ...
        eventTriggerNext.forEach((el => el.addEventListener("click", (() => {
            ...
            if (!(null === nextSlide.querySelector(".item-delivery__title"))) controllsTitle.forEach((el => el.innerHTML = nextSlide.querySelector(".item-delivery__title").innerHTML)); else controllsTitle.forEach((el => el.innerHTML = ""));
        }))));
        eventTriggerPrev.forEach((el => el.addEventListener("click", (() => {
            const prevSlide = document.querySelector(".swiper-slide-prev");
            if (!(null === prevSlide.querySelector(".item-delivery__title"))) controllsTitle.forEach((el => el.innerHTML = prevSlide.querySelector(".item-delivery__title").innerHTML)); else controllsTitle.forEach((el => el.innerHTML = ""));
        }))));
        window["FLS"] = true;
        isWebp();
        menuInit();
